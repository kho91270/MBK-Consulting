...
export const translations = {
  fr: {
    ...
    team: {
      ...
      members: [
        ...
        },
        {
          ...
          expertise: 'Management et leadership'
        },
        {
          name: 'Pierre Durand',
          role: 'Médiateur Certifié',
    ...
    contact: {
      ...
      newsletter: {
        title: 'Newsletter',
        description: 'Inscrivez-vous pour recevoir nos actualités et conseils',
  ...
  en: {
      ...
      members: [
        {
          ...
          expertise: 'Strategy and transformation'
        },
        {
          name: 'Jean Martin',
          role: 'Senior Consultant',
          expertise: 'Audit and compliance'
        },
        {
          name: 'Sophie Bernard',
          role: 'Expert Trainer',
    ...
    contact: {
      title: 'Contact us',
      subtitle: 'We are here to meet your needs',
      form: {
        name: 'Full name',
        email: 'Email',
        phone: 'Phone',
      ...
      newsletter: {
        title: 'Newsletter',
        description: 'Subscribe to receive our news and advice',
