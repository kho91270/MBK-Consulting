          ...
          {content.items.map((item, idx) => (
            <div key={idx} className="flex flex-col border-t-2 border-[#0A192F] pt-12 group">
              ...
              <div className="space-y-6 text-lg text-gray-600 font-light leading-relaxed">
                <p>
                  {language === 'fr' 
                    ? "Nous déstructurons les modèles de coûts existants pour identifier les inefficacités structurelles."
                    : "We deconstruct existing cost models to identify structural inefficiencies."}
                </p>
              </div>
            </div>
          ))}
