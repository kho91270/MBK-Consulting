    ...
    <div className="min-h-screen bg-[#0A192F] text-white font-sans">
      ...
      <div className="max-w-7xl mx-auto px-8 pb-32">
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          <div className="space-y-16 italic font-light text-2xl text-gray-300 leading-relaxed border-l-4 border-blue-600 pl-10">
            {language === 'fr' 
          ...
          <form onSubmit={(e) => {e.preventDefault(); setSubmitted(true);}} className="space-y-12 bg-white/[0.03] p-12 border border-white/10 backdrop-blur-sm">
            {submitted ? (
              ...
              <>
                <input required type="text" placeholder={language === 'fr' ? "Nom & Institution" : "Name & Institution"} className="w-full bg-transparent border-b border-white/20 py-4 focus:outline-none focus:border-blue-500 text-lg font-light" />
                <input required type="email" placeholder="Email corporate" className="w-full bg-transparent border-b border-white/20 py-4 focus:outline-none focus:border-blue-500 text-lg font-light" />
                <textarea rows="4" placeholder="Message" className="w-full bg-transparent border-b border-white/20 py-4 focus:outline-none focus:border-blue-500 text-lg font-light resize-none"></textarea>
