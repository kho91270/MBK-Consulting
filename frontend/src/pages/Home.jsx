...
const Home = () => {
  ...
  // SÉCURITÉ CRITIQUE : Si le dictionnaire 't' ou 'hero' n'est pas encore chargé,
  // on retourne null pour éviter que React ne crash (Rond Rouge).
  if (!t || !t.hero || !t.nav) {
    return (
      <div className="min-h-screen bg-[#0A192F] flex items-center justify-center">
        <div className="w-10 h-px bg-blue-600 animate-pulse"></div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative h-screen flex items-center bg-[#0A192F] px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-sm md:text-base font-bold tracking-[0.5em] text-blue-500 uppercase">
              {t.hero.subtitle || "Performance Architect"}
            </span>
          </div>

          {/* Titre H1 (7xl) - Équilibre typographique */}
          ...
          {/* Description (lg) - Lisibilité accrue */}
          ...
          {/* Actions - Boutons harmonisés */}
          <div className="flex flex-wrap gap-8 items-center">
            <Link 
              to="/audit" 
              className="group flex items-center gap-6 bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 text-[11px] font-bold uppercase tracking-[0.3em] transition-all duration-500"
            >
              {t.hero.cta || "Start Audit"}
        ...
        {/* Décoration : Ligne verticale de scroll */}
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-px h-24 bg-gradient-to-b from-blue-600 to-transparent opacity-50"></div>
      </section>
    </div>
  );
};
