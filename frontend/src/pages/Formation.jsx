        ...
        {content.items.map((item, idx) => (
          <div key={idx} className="flex flex-col border-t border-gray-100 pt-10 group">
            ...
            <p className="text-gray-500 font-light text-sm leading-relaxed">
              {language === 'fr' 
                ? "Programmes de haute spécialisation pour élever la maturité stratégique de vos équipes achats."
                : "Highly specialized programs designed to elevate the strategic maturity of your procurement teams."}
            </p>
          </div>
        ))}
      </section>
