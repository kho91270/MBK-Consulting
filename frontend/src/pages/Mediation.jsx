        ...
        {content.items.map((item, idx) => (
          <div key={idx} className="flex flex-col border-t border-gray-100 pt-10 group">
            ...
            <p className="text-gray-500 font-light text-sm leading-relaxed">
              {language === 'fr' 
                ? "Rétablissement de l'équilibre contractuel et résolution des contentieux complexes."
                : "Restoring contractual balance and resolving complex supplier disputes."}
            </p>
          </div>
        ))}
      </section>
