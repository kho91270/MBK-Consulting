          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="space-y-12">
                {pageData.benefits.map((benefit, index) => (
                  <div key={index} className="flex items-start gap-6 group">
                    <div className="w-12 h-12 bg-gray-50 flex items-center justify-center flex-shrink-0 border border-gray-100 group-hover:bg-blue-600 group-hover:text-white transition-all">
            ...
            <div className="bg-gray-50 p-12 self-start border-t-4 border-blue-600">
              <div className="flex items-center gap-4 mb-6 text-[#0A192F]">
                ...
                <h3 className="text-2xl font-bold font-serif">Missions d'Analyse</h3>
              </div>
