  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="relative w-full h-[60vh] bg-[#0A192F] overflow-hidden grayscale contrast-125">
        <img 
          src="https://images.unsplash.com/photo-1454165833767-0274b24f6733?q=80&w=2000&auto=format&fit=crop" 
          alt="Audit & Analysis" 
      ...
      <section className="py-24 px-8 max-w-7xl mx-auto grid md:grid-cols-2 gap-x-20 gap-y-16">
        {content.items.map((item, idx) => (
          <div key={idx} className="flex flex-col border-t border-gray-100 pt-10 group">
            <span className="text-[10px] text-blue-600 font-bold tracking-[0.4em] mb-6 block uppercase">
              {t.common.analysisLabel} // 0{idx + 1}
            </span>
            ...
            <p className="text-gray-500 font-light text-sm leading-relaxed">
              {language === 'fr' 
                ? "Évaluation rigoureuse des processus achats pour identifier les gisements de productivité et sécuriser la conformité."
                : "Rigorous assessment of procurement processes to identify productivity gains and ensure compliance."}
            </p>
          </div>
        ))}
      </section>
